...
TDDP.bootPreloadImages = {
    ...
    */
    ...
    for(var j = 0; j<= 3; j++) {
    for (var i = 1; i =< 20; i++) {
        "tati_huro_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 21; i++) {
        "tati_kuno_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 19; i++) {
        "tati_non_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 21; i++) {
        "tati_sia_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 1; j++) {
    for (var i = 1; i =< 16; i++) {
        "tati_saria_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 2; i++) {
        "buka_huro_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 2; i++) {
        "buka_kuno_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 2; i++) {
        "buka_non_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 3; j++) {
    for (var i = 1; i =< 2; i++) {
        "buka_sia_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
for (var j = 0; j <= 1; j++) {
    for (var i = 1; i =< 2; i++) {
        "buka_saria_" + "abcd".substr(j, 1) + ('000' + i).slice(-3)
    }
}
